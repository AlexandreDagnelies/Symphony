 ...
 *
 * @ORM\Table(name="job")
 * @ORM\Entity(repositoryClass="imie\TotoBundle\Repository\JobRepository")
...
class Job
{
     ...
     * @return Job
     */
    public function setCategory(\imie\TotoBundle\Entity\Category $category = null)
    {
     ...
     * Get category
     *
     * @return \imie\TotoBundle\Entity\Category 
     */
