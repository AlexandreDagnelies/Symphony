...
class Affiliate
{
     ...
     * Add categories
     *
     * @param \imie\TotoBundle\Entity\Category $categories
     * @return Affiliate
     */
    public function addCategory(\imie\TotoBundle\Entity\Category $categories)
    {
     ...
     * @param \imie\TotoBundle\Entity\Category $categories
     */
    public function removeCategory(\imie\TotoBundle\Entity\Category $categories)
    {
